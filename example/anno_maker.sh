...
anno_ref1=$DATA_DIR/gencode.vM12.annotation.gtf.gz
fasta1=$DATA_DIR/GRCm38.p5.genome.fa.gz
anno_ref2=$DATA_DIR/gencode.v25.annotation.gtf.gz
fasta2=$DATA_DIR/GRCh38.p7.genome.fa.gz
